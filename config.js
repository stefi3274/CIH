...
// École : CIH ( Centre de l'intelligentsia haitienne)
// ============================================================

const SCHOOL_CONFIG = {

  // ── Identité ─────────────────────────────────────────────
  name:         "CIH ( Centre de l'intelligentsia haitienne)",
  director:     "Jean Franck Saint-Cyr",
  city:         "Port-au-Prince",
  department:   "Ouest",
  address:      "4, Rue Scott, Eden Village, Delmas 33 prolongé, Port-au-Prince, HT6120",
  phone:        "+ 509 28 12 6141",
  email:        "contact@ecole.ht",
  emoji:        "🎓",
